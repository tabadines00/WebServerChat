  ...
  return (
    <div className="notes-container">
      ...
      <footer className="footer">
        ...
        <button className="send-button" onClick={submitNote}><svg class="bi bi-chat" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
